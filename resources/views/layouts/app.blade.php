                            ...
                            <ul>
                                <li><i class="fi-rs-user"></i> {{ Auth::user()->name }}
                                    <form action="{{route('logout')}}" method="POST">
                                        @csrf
                                        <a href="{{route('logout')}}" onclick="event.parentDefault(); this.closest('form').submit();"></a>
                                        <button [type="submit" ]:hovor{color:black} style="background:none; border: none; padding: 0; color:none;">Logout</button>
                                    </form>
                                </li>
                            </ul>
                            @else
